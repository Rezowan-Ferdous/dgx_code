...
from .preprocess import ReducedKernelConv,extract_features_dinov2,extract_features
...
def make_full_df(files_df, actiondict, sample_rate):
    ...
    files_df['num_frames'] = num_frames
    files_df['segmetns'] = allsegmetns
    files_df['lables'] = alllabels
